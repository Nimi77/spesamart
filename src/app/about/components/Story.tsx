      ...
      <div className="flex flex-col-reverse items-center justify-center gap-12 md:flex-row">
        <div className="w-full">
          ...
          <p className="pb-6 pt-4">
            Launched in 2015, Buyo is South Asia’s premier online shopping
            makterplace with an active presense in Bangladesh. Supported by wide
            range of tailored marketing, data and service solutions, Buyo has
            10,500 sallers and 300 brands and serves 3 millions customers across
            the region.
          </p>
          <p>
            Buyo has more than 1 Million products to offer, growing at a very
            fast. Buyo offers a diverse assotment in categories ranging from
            consumer.
          </p>
        </div>
